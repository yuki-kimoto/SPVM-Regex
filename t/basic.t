...
# SPVM::Regex
{
  ...
  ok(SPVM::TestCase::Regex->match_v2_extra);
  ok(SPVM::TestCase::Regex->match_v2_extra_forward);
  ok(SPVM::TestCase::Regex->buffer_match_v2_extra);
  ok(SPVM::TestCase::Regex->buffer_match_v2_extra_forward);
  ok(SPVM::TestCase::Regex->replace_v2);
  ok(SPVM::TestCase::Regex->replace_v2_g);
  ok(SPVM::TestCase::Regex->buffer_replace_v2);
  ok(SPVM::TestCase::Regex->buffer_replace_v2_g);
