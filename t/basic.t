...
# SPVM::Regex
{
  ...
  ok(SPVM::TestCase::Regex->match_v2);
  ok(SPVM::TestCase::Regex->match_v2_forward);
  ok(SPVM::TestCase::Regex->buffer_match_v2);
  ok(SPVM::TestCase::Regex->buffer_match_v2_forward);
